...
public partial class TileBuilder
{
    ...
    private static Quad Square1x1(ref MeshBuilder builder, float uvTweak = 0f)
    {
        int w00 = builder.AddVertex(new(0, 0, 0), new(0, 1, 0), new(0, 0), uvTweak);
        int w01 = builder.AddVertex(new(0, 0, 1), new(0, 1, 0), new(0, 1), uvTweak);
        int w11 = builder.AddVertex(new(1, 0, 1), new(0, 1, 0), new(1, 1), uvTweak);
